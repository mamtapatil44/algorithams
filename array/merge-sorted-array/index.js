...
function mergedSortedArray(arr1,arr2){
    ...
    //   here we compare first elements of both array and whichever is small push it into merged array
        if(arr1[i] < arr2[j] && arr1[i] !== mergedArr[i]){
            mergedArr.push(arr1[i]);
            i++;
        } else if (arr1[i] > arr2[j] && arr2[j] !== mergedArr[j]){
...
console.log("mergedsorted array=== ",mergedSortedArray([1,3,5,7,9],[2,4,6,8]))

console.log("mergedsorted array=== ",mergedSortedArray([1,3,5,7,9],[2,4,6,8,9]))